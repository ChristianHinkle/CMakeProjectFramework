...
project(${MY_BASE_PROJECT_NAME_FULL}_Object
  VERSION 0.1.0
  LANGUAGES CXX
  )
...
add_library(${MY_BASE_PROJECT_NAME_FULL}_Object OBJECT)
...
set_target_properties(${MY_BASE_PROJECT_NAME_FULL}_Object
  PROPERTIES
...
generate_export_header(${MY_BASE_PROJECT_NAME_FULL}_Object
  BASE_NAME ${MY_BASE_PROJECT_NAME_FULL}
  EXPORT_FILE_NAME "${CMAKE_CURRENT_BINARY_DIR}/Include/${MY_BASE_PROJECT_NAME_FULL_LOWERCASE}_object_export.h"
  INCLUDE_GUARD_NAME "${MY_BASE_PROJECT_NAME_FULL_UPPERCASE}_OBJECT_EXPORT_H"
  )

# List out required language features.
target_compile_features(${MY_BASE_PROJECT_NAME_FULL}_Object
  PUBLIC
    cxx_std_20
  )
...
#
target_sources(${MY_BASE_PROJECT_NAME_FULL}_Object
  PUBLIC
    FILE_SET ${MY_BASE_PROJECT_NAME_FULL_LOWERCASE}_object_public_headers
      TYPE HEADERS
      BASE_DIRS
        "${CMAKE_CURRENT_BINARY_DIR}/Include" # The base directory of generated headers.
      FILES
        "${CMAKE_CURRENT_BINARY_DIR}/Include/${MY_BASE_PROJECT_NAME_FULL_LOWERCASE}_object_export.h"
  )
...
target_link_libraries(${MY_BASE_PROJECT_NAME_FULL}_Object
  INTERFACE
...
install(TARGETS ${MY_BASE_PROJECT_NAME_FULL}_Object
  ...
  FILE_SET ${MY_BASE_PROJECT_NAME_FULL_LOWERCASE}_object_public_headers DESTINATION "${CMAKE_INSTALL_INCLUDEDIR}/${PROJECT_NAME}"
  )
